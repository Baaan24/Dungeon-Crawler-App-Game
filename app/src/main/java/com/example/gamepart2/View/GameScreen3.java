...
//        characterSprite.setImageDrawable(gameViewModel.getPLayerSprite());
    ...
    public void playerLose() {
        ...
        Intent inte = new Intent(GameScreen3.this, LosingEndScreen.class);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (isWithinScreenBoundaries(newX, newY)) {
            ...
            if (playerX + characterSprite.getWidth() >= screenWidth) {
                    // Start a new activity and pass the desired position data
                if (gameViewModel.getPlayerScore() <= 0) {
                    Intent inte = new Intent(GameScreen3.this, LosingEndScreen.class);
                    Bundle playerinfo = new Bundle();
                    playerinfo.putInt("score", 0);
                    inte.putExtras(playerinfo);
                    inte.putExtra("hp", hp);
                    inte.putExtra("character", character);
                    startActivity(inte);
                    ...
                    Intent inte = new Intent(GameScreen3.this, EndScreen.class);
                    Bundle playerinfo = new Bundle();
                    playerinfo.putInt("score", gameViewModel.getPlayerScore());
                    inte.putExtras(playerinfo);
                    inte.putExtra("hp", hp);
