...
public class Enemy3 implements Enemy {
    ...
    public Enemy3(int speed, float x, float y, int screenWidth, int screenHeight, Context context) {
        this.speed = speed;
        this.spriteResource = R.drawable.enemy3;
        this.x = x;
        this.y = y;
    ...
    public void display(View view) {
        ImageView enemyView = view.findViewById(R.id.enemy3View);
        enemyView.setX(x); // Set X position
        enemyView.setY(y); // Set Y position
        enemyView.setImageResource(R.drawable.enemy3);
    }
    ...
    public void move() {
        ...
        // Get the dimensions of the enemy sprite
        int spriteWidth = 100;
        int spriteHeight = 100;


        // Check if the enemy has reached the screen boundaries horizontally
