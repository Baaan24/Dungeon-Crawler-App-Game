...
public class GameScreen1 extends AppCompatActivity {
    ...
    private int playerX,playerY, screenWidth, screenHeight;
    private int hp;
    ImageView powerUp1;
    ImageView powerUp2;
    ImageView powerUp3;
    ...
    public void playerLose() {
        ...
        Intent inte = new Intent(GameScreen1.this, LosingEndScreen.class);
            ...
            public void run() {
                ...
                for (Enemy enemy : enemies) {
                    ...
                    if (!isPlayerInvincible && checkCollision(playerX, playerY, characterSprite.getWidth(),
                            ...
                            hP.setText(String.valueOf(Players.getPlayer().getHealth()));
